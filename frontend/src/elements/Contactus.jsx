    ...
    <div>
      ...
      <div className="container mx-auto px-4 lg:px-16 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          {/* Contact Form */}
          {/* Optional: If you want this instead of department info, move this to replace the above */}
          {/* 
          <div className="bg-white p-6 rounded-xl shadow-lg">
            ...
            <form>
              <div className="mb-4">
                ...
                <input type="text" placeholder="Enter your name" className="w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-[#F34900] outline-none" />
              </div>
              <div className="mb-4">
                <label className="block text-gray-700 font-medium mb-2">Email</label>
                <input type="email" placeholder="Enter your email" className="w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-[#F34900] outline-none" />
              </div>
              <div className="mb-4">
                <label className="block text-gray-700 font-medium mb-2">Message</label>
                <textarea rows="4" placeholder="Write your message..." className="w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-[#F34900] outline-none"></textarea>
              </div>
              <button type="submit" className="w-full bg-[#F34900] text-white font-semibold py-2 rounded-md hover:bg-[#d93d00] transition-all">
                Send Message
              </button>
            </form>
          </div>
