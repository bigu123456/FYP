...
const OrderPage = () => {
  ...
  {(() => {
    ...
    const driverCost = selectedDriver ? selectedDriver.price_per_day * priceSummary.duration : 0;
    const originalCost = vehicleCost + driverCost;
    return (
      <div className="flex justify-between">
        <p className="text-gray-600 font-semibold">Original Price:</p>
        <p className="font-medium text-gray-800">₹{originalCost.toFixed(2)}</p>
      </div>
    );
  })()}
                        <div className="flex justify-between">
